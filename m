Return-Path: <kernel-janitors+bounces-10258-lists+kernel-janitors=lfdr.de@vger.kernel.org>
Delivered-To: lists+kernel-janitors@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id qHa2Kvddq2mmcQEAu9opvQ
	(envelope-from <kernel-janitors+bounces-10258-lists+kernel-janitors=lfdr.de@vger.kernel.org>)
	for <lists+kernel-janitors@lfdr.de>; Sat, 07 Mar 2026 00:06:31 +0100
X-Original-To: lists+kernel-janitors@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 092552287F0
	for <lists+kernel-janitors@lfdr.de>; Sat, 07 Mar 2026 00:06:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 5E66E3051D00
	for <lists+kernel-janitors@lfdr.de>; Fri,  6 Mar 2026 23:06:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 343B63624BD;
...
X-Spamd-Result: default: False [0.94 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-10258-lists,kernel-janitors=lfdr.de];
	R_DKIM_REJECT(0.00)[synopsys.com:s=selector1];
	RCVD_TLS_LAST(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[linaro.org:email,synopsys.com:dkim,synopsys.com:email,synopsys.com:mid,sea.lore.kernel.org:rdns,sea.lore.kernel.org:helo,urldefense.com:url];
	...
	FROM_NEQ_ENVFROM(0.00)[Thinh.Nguyen@synopsys.com,kernel-janitors@vger.kernel.org];
	FROM_HAS_DN(0.00)[];
