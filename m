Return-Path: <kernel-janitors+bounces-1075-lists+kernel-janitors=lfdr.de@vger.kernel.org>
X-Original-To: lists+kernel-janitors@lfdr.de
Delivered-To: lists+kernel-janitors@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id A83A0825B97
	for <lists+kernel-janitors@lfdr.de>; Fri,  5 Jan 2024 21:26:33 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 1D87C1F2323C
	for <lists+kernel-janitors@lfdr.de>; Fri,  5 Jan 2024 20:26:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E9CE1364A6;
	Fri,  5 Jan 2024 20:26:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="X7inZGPf"
X-Original-To: kernel-janitors@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.100])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7A844360BC;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=X7inZGPf5eDu6GDKazJ9AUWyWFSyIWL0TS7NFsKejsbLsr/FRsHjT2fL
   ...
   zEPpkmIbkZqS7b0seMlVHGyBRV53wdfKPT/GoX7ugZw3QAa6iEDdafIBN
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10944"; a="463975135"
X-IronPort-AV: E=Sophos;i="6.04,334,1695711600"; 
   d="scan'208";a="463975135"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Jan 2024 12:26:11 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10944"; a="899748272"
X-IronPort-AV: E=Sophos;i="6.04,334,1695711600"; 
   d="scan'208";a="899748272"
Received: from orsmsx603.amr.corp.intel.com ([10.22.229.16])
  by fmsmga002.fm.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 05 Jan 2024 12:26:11 -0800
...
CC: Himal Prasad Ghimiray <himal.prasad.ghimiray@intel.com>, Lucas De Marchi
 ...
 Lankhorst" <maarten.lankhorst@linux.intel.com>, Maxime Ripard
	...
	<rodrigo.vivi@intel.com>, Matthew Auld <matthew.auld@intel.com>, Nirmoy Das
	<nirmoy.das@intel.com>, Matt Roper <matthew.d.roper@intel.com>, "Pallavi
 Mishra" <pallavi.mishra@intel.com>, <intel-xe@lists.freedesktop.org>,
...
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:PH7PR11MB6522.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(39860400002)(396003)(136003)(366004)(346002)(376002)(230922051799003)(1800799012)(451199024)(64100799003)(186009)(83380400001)(86362001)(478600001)(6512007)(41300700001)(6506007)(82960400001)(6666004)(44832011)(54906003)(5660300002)(7416002)(2906002)(6486002)(6916009)(316002)(66476007)(66946007)(66556008)(8676002)(8936002)(4326008)(38100700002)(26005)(67856001);DIR:OUT;SFP:1102;
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 05 Jan 2024 20:26:06.0161
 (UTC)
