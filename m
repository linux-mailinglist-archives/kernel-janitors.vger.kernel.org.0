...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DC70B235608
	for <lists+kernel-janitors@lfdr.de>; Sun,  2 Aug 2020 10:47:23 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726086AbgHBIrW (ORCPT <rfc822;lists+kernel-janitors@lfdr.de>);
        Sun, 2 Aug 2020 04:47:22 -0400
Received: from mail3-relais-sop.national.inria.fr ([192.134.164.104]:11665
        "EHLO mail3-relais-sop.national.inria.fr" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1725819AbgHBIrW (ORCPT
        <rfc822;kernel-janitors@vger.kernel.org>);
        Sun, 2 Aug 2020 04:47:22 -0400
X-IronPort-AV: E=Sophos;i="5.75,425,1589234400"; 
   d="scan'208";a="355794668"
Received: from abo-173-121-68.mrs.modulonet.fr (HELO hadrien) ([85.68.121.173])
  by mail3-relais-sop.national.inria.fr with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 02 Aug 2020 10:47:14 +0200
Date:   Sun, 2 Aug 2020 10:47:13 +0200 (CEST)
From:   Julia Lawall <julia.lawall@inria.fr>
X-X-Sender: jll@hadrien
To:     Thierry Moreau <thierry.moreau@connotech.com>
cc:     kernel-janitors@vger.kernel.org
Subject: Re: gma500: monitor-dependent failure to boot FB console
 (psbdrmfb)
In-Reply-To: <361913a2-faed-fee8-45c3-90f8b3cf4a87@connotech.com>
Message-ID: <alpine.DEB.2.22.394.2008021046100.2531@hadrien>
References: <361913a2-faed-fee8-45c3-90f8b3cf4a87@connotech.com>
...
On Sat, 1 Aug 2020, Thierry Moreau wrote:
...
>
> With two ASUS monitors, the above line in the boot log never appears. And
> theconsole turns blank early in the boot process. A single entry appears in
...
>
> Looking in the kernel source tree, 'psbdrmfb' is a frame buffer name appearing
> once in the GMA500 GPU source code.
>
...
The MAINTAINERS file or the get_maintainer.pl script should be able to
...
>
> ============================ boot sequence, 'pass'
> pass:[    0.000000] Linux version 4.19.48 (root@dodeca1er) (gcc version 8.4.0
> (CRUX-x86_64-multilib)) #5 SMP Fri Jul 31 03:17:03 UTC 2020
...
> pass-[    0.880497] ACPI: Video Device [GFX0] (multi-head: yes  rom: no post:
> no)
...
> pass-[    0.889340] snd_hda_codec_hdmi hdaudioC0D1: HDMI: Unknown ELD version
> 1
> --
...
> pass-[    1.640569] snd_hda_codec_hdmi hdaudioC0D1: HDMI: Unknown ELD version
> 1
> --
> pass-[    2.279237] snd_hda_codec_hdmi hdaudioC0D1: HDMI: Unknown ELD version
> 1
...
> left
> ============================ boot sequence, 'fail'
> fail:[    0.000000] Linux version 4.19.48 (root@dodeca1er) (gcc version 8.4.0
> (CRUX-x86_64-multilib)) #5 SMP Fri Jul 31 03:17:03 UTC 2020
...
> fail-[    0.879977] ACPI: Video Device [GFX0] (multi-head: yes  rom: no post:
> no)
...
> fail-[    0.888879] snd_hda_codec_hdmi hdaudioC0D1: HDMI: Unknown ELD version
> 1
> --
