...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CB57A2BB8C4
	for <lists+kernel-janitors@lfdr.de>; Fri, 20 Nov 2020 23:18:50 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728600AbgKTWQB (ORCPT <rfc822;lists+kernel-janitors@lfdr.de>);
        Fri, 20 Nov 2020 17:16:01 -0500
Received: from mga11.intel.com ([192.55.52.93]:1948 "EHLO mga11.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727974AbgKTWQA (ORCPT <rfc822;kernel-janitors@vger.kernel.org>);
        Fri, 20 Nov 2020 17:16:00 -0500
IronPort-SDR: jGeo6et3zu/WKnEFEXX5cVduTLs36aXaPaKb/7uoQi+kfTxMDkkqBsUJ0KqnfS0XKUaG8rKS/f
 dRXQJ08t+R1g==
X-IronPort-AV: E=McAfee;i="6000,8403,9811"; a="168040837"
X-IronPort-AV: E=Sophos;i="5.78,357,1599548400"; 
   d="scan'208";a="168040837"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 20 Nov 2020 14:15:59 -0800
IronPort-SDR: aMCsvitcStMGQb+wGEGBt8T1upTCxofK+hNN2NocMefsrIENZk7oPS2zU8zlk+/DQQmSuEI+Gi
 DKnY1PZ21gbQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,357,1599548400"; 
   d="scan'208";a="431704883"
...
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:BY5PR11MB4182.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(4636009)(136003)(39860400002)(376002)(366004)(396003)(346002)(4326008)(54906003)(2906002)(71200400001)(478600001)(33656002)(186003)(6916009)(83380400001)(8936002)(53546011)(9686003)(8676002)(7696005)(55016002)(6506007)(66446008)(66946007)(52536014)(64756008)(86362001)(76116006)(26005)(316002)(66476007)(66556008)(5660300002);DIR:OUT;SFP:1102;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 20 Nov 2020 22:15:57.3508
 (UTC)
...
> + err_clear_drvdata:
We still need to unregister the dsi_host that was registered in this call k=
mb_dsi_host_bridge_init.
This will require more changes in kmb_dsi_host_unregister and/or separate o=
ut mipi_dsi_host_unregister.
